...
public class ServletModificar extends HttpServlet {
    ...
    //doGet es para cargar la informacion del alumno seleccionado
    //doPost para guardar la informacion de los cambios aplicados sobre el alumno
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(modificar != null) {
            ...
            String idAlumnoS = request.getParameter("idAlumno");
            Integer idAlumno = Integer.parseInt(idAlumnoS);
            Alumno alumnno = new Alumno(idAlumno);
            servicioAlumno.eliminarAlumno(alumnno);
        }
